# Pholcus    [![GoDoc](https://godoc.org/github.com/tsuna/gohbase?status.png)](https://godoc.org/qtrx.io/lycosa) [![GitHub release](https://img.shields.io/github/release/henrylee2cn/pholcus.svg)](https://qtrx.io/lycosa/releases)
...
![image](https://qtrx.io/lycosa/raw/master/doc/icon.png)

* 官方QQ群：Go大数据 42731170    [![Go大数据群](http://pub.idqqimg.com/wpa/images/group.png)](http://jq.qq.com/?_wv=1027&k=XnGGnc)

# 爬虫原理

![image](https://qtrx.io/lycosa/raw/master/doc/module.png)

&nbsp;

![image](https://qtrx.io/lycosa/raw/master/doc/project.png)

&nbsp;

![image](https://qtrx.io/lycosa/raw/master/doc/distribute.png)
...
```
go get -u -v qtrx.io/lycosa
```

备注：Pholcus公开维护的spider规则库地址 <https://qtrx.io/lycosa_lib>
...
正常编译方法
```
cd {{replace your gopath}}/src/qtrx.io/lycosa
...
pholcus -h
```
![image](https://qtrx.io/lycosa/raw/master/doc/help.jpg)

&nbsp;

> *<font size="2">Web版操作界面截图如下：*

![image](https://qtrx.io/lycosa/raw/master/doc/webshow_1.jpg)

&nbsp;

> *<font size="2">GUI版操作界面之模式选择界面截图如下*

![image](https://qtrx.io/lycosa/raw/master/doc/guishow_0.jpg)
...
"qtrx.io/lycosa_lib" // 此为公开维护的spider规则库
```
> *<font size="2">（在此感谢以上开源项目的支持！）</font>*

# 开源协议

Pholcus（幽灵蛛）项目采用商业应用友好的[Apache License v2](https://qtrx.io/lycosa/raw/master/LICENSE).发布
